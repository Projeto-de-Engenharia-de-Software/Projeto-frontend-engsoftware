...
def get_equipes():
    """
    Busca as equipes do usuário autenticado.
    Restaura o token do cookie para a sessão, se necessário.
    """
    # Garante que token esteja na sessão
    ...
    # Requisição autenticada usando função utilitária
